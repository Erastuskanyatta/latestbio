     ...
     <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                           <a style="padding-right: 20px"  href="<?= Yii::$app->urlManager->createUrl(['site/twishprofile'])?>">Twish profile</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="wrapper wrapper-content">
                <div class="row animated fadeInRight">
                    <div class="col-lg-4">
                        ...
                        <div class="ibox-content no-padding border-left-right">
                             <img  src="<?= Yii::$app->getUrlManager()->getBaseUrl()."/as/image/1.jpg"?>" alt="image description" width="340" height="350"> 
                        </div>
                        <div class="ibox-content profile-content">
                            <h4> Caroline Gatwili </h4> <br>
                            647 <strong>Nyeri</strong> <br> <br>
                            <h3 style: color: white;>About Me</h3> 
                            <p>I am Caroline Gatwili <br>I am the the marketer at sudo coders team <br>I have more than 10 projects in Sudo coders</p> <br>
                            ...
                            <div class="user-button">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a style="padding-right: 20px; color: white;"  href="<?= Yii::$app->urlManager->createUrl(['coffee/create'])?>">Buy me coffee</a> 
                                             </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="ibox-content">
                           ...
                           <h5>
                           <a style="padding-right: 20px"  href="<?= Yii::$app->urlManager->createUrl(['site/twishprofile'])?>">  You</a> 
                            started following 
                ...
                <div class="ibox-content">
                           ...
                           <h5>
                            <strong>
                                 <a style="padding-right: 20px"  href="<?= Yii::$app->urlManager->createUrl(['site/twishprofile'])?>">  You</a>Wrote a message to   
                           ...
                           <p>
                               Hello bro...I want us to meet at 5pm...Got a problem with argular..kindly <strong>Update me</strong>
                           </p>
                            <div class="pull-left">
                                     <img class="img-circle" src="<?= Yii::$app->getUrlManager()->getBaseUrl()."/as/image/jeff.jpg"?>" alt="image description" width="50" height="50">
                                </div>
