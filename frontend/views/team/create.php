    ...
    <div class="service-block col-md-4">
       ...
       <div class="service-block col-md-4">
        ...
        <div class="card-body text-center">
                 ...
                 <img  style="height:200px; width: 200px"  src="<?= Yii::$app->getUrlManager()->getBaseUrl()."/as/image/jeff.jpg"?>" alt="image description" width="40" height="40" style="border: top: 134px;">    <br>        
            </div>
